...
def test_eth_sign_request_wire_structure():
    ur_type, payload, rid = eth.encode_eth_sign_request(
...
def test_optional_fields_are_omitted():
    _ur, payload, _ = eth.encode_eth_sign_request(
